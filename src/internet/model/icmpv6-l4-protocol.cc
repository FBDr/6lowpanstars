...
namespace ns3
{
    ...
    const uint32_t Icmpv6L4Protocol::REACHABLE_TIME = 2000000000; //Approaching MAX of uint32_t
    const uint32_t Icmpv6L4Protocol::RETRANS_TIMER = 100; // When set to 100, problem solved.
