        ...
        <html>
            ...
            <body>
                ...
                <footer>
                    ...
                    <a target="_blank" href="http://named-data.net/doc/NFD/">
                        <span class="green">NFD version <xsl:value-of select="$version"/></span>
                    </a>
    ...
    <xsl:template match="nfd:generalStatus">
        ...
        <table class="item-list">
            ...
            <tbody>
                <tr class="center">
                    <td>
                        <xsl:apply-templates select="nfd:nfdId"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:version"/>
                    </td>
                    <td>
                        <xsl:call-template name="formatDate">
                            <xsl:with-param name="date" select="nfd:startTime" />
                        </xsl:call-template>
                    </td>
                    <td>
                        <xsl:call-template name="formatDate">
                            <xsl:with-param name="date" select="nfd:currentTime" />
                        </xsl:call-template>
                    </td>
                    <td>
                        <xsl:call-template name="formatDuration">
                            <xsl:with-param name="duration" select="nfd:uptime" />
                        </xsl:call-template>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:nNameTreeEntries"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:nFibEntries"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:nPitEntries"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:nMeasurementsEntries"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:nCsEntries"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:packetCounters/nfd:incomingPackets/nfd:nInterests"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:packetCounters/nfd:outgoingPackets/nfd:nInterests"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:packetCounters/nfd:incomingPackets/nfd:nDatas"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:packetCounters/nfd:outgoingPackets/nfd:nDatas"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:packetCounters/nfd:incomingPackets/nfd:nNacks"/>
                    </td>
                    <td>
                        <xsl:value-of select="nfd:packetCounters/nfd:outgoingPackets/nfd:nNacks"/>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="item-list">
            ...
            <tbody>
                <xsl:for-each select="nfd:channel">
                    ...
                    <tr class="{$style}">
                        <td>
                            <xsl:value-of select="nfd:localUri"/>
                        </td>
                    </tr>
                </xsl:for-each>
            </tbody>
        ...
        <table class="item-list">
            ...
            <tbody>
                <xsl:for-each select="nfd:face">
                    ...
                    <tr class="{$style}">
                        <td>
                            <xsl:value-of select="nfd:faceId"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:remoteUri"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:localUri"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:faceScope"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:facePersistency"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:linkType"/>
                        </td>
                        <td>
                            <xsl:choose>
                        ...
                        <td>
                            <xsl:choose>
                                <xsl:when test="nfd:expirationPeriod">
                                    <xsl:call-template name="formatDuration">
                                        <xsl:with-param name="duration" select="nfd:expirationPeriod" />
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:otherwise>
                                    Never
                        ...
                        <td>
                            <xsl:value-of select="nfd:byteCounters/nfd:incomingBytes"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:packetCounters/nfd:outgoingPackets/nfd:nInterests"/>
                        </td>
                        ...
                        <td>
                            <xsl:value-of select="nfd:byteCounters/nfd:outgoingBytes"/>
                        </td>
                    </tr>
                </xsl:for-each>
            </tbody>
                ...
                <xsl:for-each select="nfd:fibEntry">
                    ...
                    <tr class="{$style}">
                        <td style="text-align:left;vertical-align:top;padding:0">
                            <xsl:value-of select="nfd:prefix"/>
                        </td>
                        <td>
                        ...
                        <td>
                            <table class="item-sublist">
                                ...
                                <tr>
                                    ...
                                    <xsl:for-each select="nfd:routes/nfd:route">
                                        <td>
                                            <xsl:value-of select="nfd:origin"/>
                                        </td>
                                    </xsl:for-each>
                                </tr>
                                <tr>
        ...
        <table class="item-list">
            ...
            <tbody>
                <xsl:for-each select="nfd:strategyChoice">
                    <tr>
                        <td>
                            <xsl:value-of select="nfd:namespace"/>
                        </td>
                        <td>
                            <xsl:value-of select="nfd:strategy/nfd:name"/>
                        </td>
                    </tr>
                </xsl:for-each>
            </tbody>
