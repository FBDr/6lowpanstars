    ...
    namespace tests {
        ...
        BOOST_AUTO_TEST_CASE(FaceCreate) {
            ...
            createFace(factory,
                    ...
                    false,{CreateFaceExpectedResult::FAILURE, 504, "No channels available to connect"});
            ...
            createFace(factory,
                    ...
                    ndn::nfd::FACE_PERSISTENCY_PERSISTENT,
                    false,{CreateFaceExpectedResult::SUCCESS, 0, ""});
        }
        ...
        BOOST_AUTO_TEST_CASE(UnsupportedFaceCreate) {
            ...
            createFace(factory,
                    ...
                    false,{CreateFaceExpectedResult::FAILURE, 406,
