        ...
        namespace scheduler {
            namespace tests {
                ...
                BOOST_AUTO_TEST_CASE(CallbackException) {
                    ...
                    scheduler.scheduleEvent(time::milliseconds(10), [] {
                        BOOST_THROW_EXCEPTION(MyException()); });

                    bool isCallbackInvoked = false;
                    scheduler.scheduleEvent(time::milliseconds(20), [&isCallbackInvoked] {
                ...
                BOOST_AUTO_TEST_CASE(Destruct) {
                    int hit = 0;
                    {
                        ...
                        se = scheduler.scheduleEvent(time::milliseconds(10), [&] {
                            ++hit; });
                ...
                BOOST_AUTO_TEST_CASE(Assign) {
                    ...
                    se1 = scheduler.scheduleEvent(time::milliseconds(10), [&] {
                        ++hit1; });
                    se1 = scheduler.scheduleEvent(time::milliseconds(10), [&] {
                        ++hit2; });
                    this->advanceClocks(time::milliseconds(1), 15);
