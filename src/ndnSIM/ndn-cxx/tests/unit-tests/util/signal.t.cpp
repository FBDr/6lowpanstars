        ...
        namespace signal {
            namespace tests {
                ...
                BOOST_AUTO_TEST_CASE(ManualDisconnect) {
                    ...
                    int hit = 0;
                    Connection c1 = so.sig.connect([&hit] {
                        ++hit; });
                ...
                BOOST_AUTO_TEST_CASE(ManualDisconnectDestructed) {
                    ...
                    int hit = 0;
                    Connection connection = so->sig.connect([&hit] {
                        ++hit; });
                ...
                BOOST_AUTO_TEST_CASE(AutoDisconnect) {
                    ...
                    int hit = 0;
                    {
                        ScopedConnection sc = so.sig.connect([&hit] {
                            ++hit; });
                ...
                BOOST_AUTO_TEST_CASE(AutoDisconnectAssign) {
                    ...
                    int hit1 = 0, hit2 = 0;
                    ScopedConnection sc = so.sig.connect([&hit1] {
                        ++hit1; });
                    BOOST_CHECK_EQUAL(sc.isConnected(), true);
                    ...
                    sc = so.sig.connect([&hit2] {
                        ++hit2; }); // handler1 is disconnected
                    BOOST_CHECK_EQUAL(sc.isConnected(), true);
                ...
                BOOST_AUTO_TEST_CASE(ConnectSingleShotDisconnected) {
                    ...
                    int hit = 0;
                    Connection conn = so.sig.connectSingleShot([&hit] {
                        ++hit; });
                ...
                BOOST_AUTO_TEST_CASE(ConnectSingleShot1) {
                    ...
                    int hit = 0;
                    se.sig.connectSingleShot([&hit] (int) {
                        ++hit; });
