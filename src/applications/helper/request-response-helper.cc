...
RequestResponseClientHelper::RequestResponseClientHelper (Ipv4Address address, uint16_t port)
{
  m_factory.SetTypeId (RequestResponseClient::GetTypeId ());
...
RequestResponseClientHelper::RequestResponseClientHelper (Ipv6Address address, uint16_t port)
{
  m_factory.SetTypeId (RequestResponseClient::GetTypeId ());
  SetAttribute ("RemoteAddress", AddressValue (Address(address)));
  SetAttribute ("RemotePort", UintegerValue (port));
