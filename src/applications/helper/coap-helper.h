...
namespace ns3 {
    ...
    public:
         ...
         * Create a CoapServerApplication on the specified Node.
         *
         * \param Content Set content number available at server.
         *
         * 
         */
    ...
    public:
         ...
         * \param port The port the server will wait on for incoming packets
         */
        CoapCacheGtwHelper(uint16_t port);
    ...
    public:
        ...
        /**
         * Given a pointer to a CoapClient application, set the data fill of the 
         ...
         *
         * \param app Smart pointer to the application (real type must be CoapClient).
