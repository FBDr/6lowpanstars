...
% % LTE from theory to practice
        ...
        f = 2160e6;
% carrier freq Hz, EARFCN = 500 (downlink)
nrbs = 25;
...
% tx power dBm
txPsd = p - 10 * log10(bw);
% power / bandwidth in linear units
nf = 9;
...
g1 = gain_freespace(abs(x - 1000), f);
% propagation gain from
        % eNB 1
        g2 = gain_freespace(abs(x - 2000), f);
% propagation gain from
        % eNB 2

        sinr1 = 10. * log10(pW .* g1 . / (nW + pW .* g2));
% dB
sinr2 = 10. * log10(pW .* g2 . / (nW + pW .* g1));
% dB
...
hox200mps = 200 * 8.41193;
#speed * handover time
hox150mps = 150 * 10.7719;
#speed * handover time
